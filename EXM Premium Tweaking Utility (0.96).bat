...
timeout /t 1 /nobreak > NUL
chcp 437 >nul 2>&1
powershell -NoProfile -NonInteractive -Command start -verb runas "'%~s0'" & exit >nul 2>&1
chcp 65001 >nul 2>&1
...
chcp 437 >nul 2>&1
curl -g -k -L -# -o "%temp%\NvidiaProfileInspector.zip" "https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip" 
powershell -NoProfile Expand-Archive '%temp%\NvidiaProfileInspector.zip' -DestinationPath 'C:\exm\NvidiaProfileInspector' 
...
echo. ═════════════════════════════════	
chcp 437 >nul 2>&1
curl -g -k -L -# -o "%temp%\exm.zip" "https://cdn.discordapp.com/attachments/1129168931081428992/1182647895523086376/r.zip?ex=658575ae&is=657300ae&hm=4982dda4be0b53b84a84c9b380e4a41ed021c8399b657a46320c07ce7010551f&"
powershell -NoProfile Expand-Archive '%temp%\exm.zip' -DestinationPath 'c:\' 
chcp 65001 >nul 2>&1 
...
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                                          Updated 8th December  *  Version 0.96                                                   %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.       %b%║%w%                                                                                                                                                  %b%║
...
echo.       %b%║%w%                                                                                                                                                  %b%║                                                           
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                   %p%[1]%w% Windows                 %p%[2]%w% Cpu Tweaks           %p%[3]%w% Power Tweaks                                          %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
...
echo.       %b%║%w%                                                                                                                                                  %b%║ 
echo.       %b%║%w%                                   %p%[13]%w% Gpu Tweaks             %p%[14]%w% Bios Tweaks         %p%[15]%w% Optimize Games                                       %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                   %p%[16]%w% Mouse and Keyboard     %p%[17]%w% Clean               %p%[18]%w% DirectX Tweaks                                       %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                   %p%[19]%w% Additonal Tweaks       %p%[20]%w% Debloat             %p%[21]%w% Network                                              %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.       %b%║%w%                                                                                                                                                  %b%║ 
...
echo.
echo.
echo.                                                           Type%p% "X" %w%to go back to menu
echo.
echo.                                %b%"════════════════════════════════════════════════════════════════════════════"
set /p input=:
...
:c18
echo %w%- If you are stuck, press enter %b%
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v "DistributeTimers" /t REG_DWORD /d "1" /f
...
:c5
echo %w%- Device Idle Policy: Performance %b%
...
:c8
echo %w%- Dont restrict core boost %b%
...
echo.
echo.                                     %p%[21]%w% Optimize CapabilityAccessManager %p%[22]%w% Optimize Windows Privacy Settings     
echo.  
...
echo.
echo.        %b% ══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
echo.           %W%                           Resources missing, Make sure you are running the newest version. 
echo.           %w%                                 Redownload the utility from the exm customer server.
echo.        %b% ══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
echo.
echo.                                                     
echo.
...
echo.
echo.                                                   %b%════════════════════════════════════
echo.                                                   %b% %w%  Press any key to exit...       
echo.                                                   %b%════════════════════════════════════                                                      
pause > nul
cls
...
echo %w%-  Disable Animations in the taskbar %b%
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "TaskbarAnimations" /t REG_DWORD /d 0 /f
timeout /t 1 /nobreak > NUL

echo %w%- Show translucent selection rectangle %b%
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "ListviewAlphaSelect" /t REG_DWORD /d 0 /f
timeout /t 1 /nobreak > NUL

echo %w%- Disable balloon tips %b%
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "EnableBalloonTips" /t REG_DWORD /d "0" /f
timeout /t 1 /nobreak > NUL

echo %w%- Disable windows aero shake %b%
Reg.exe add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "DisallowShaking" /t REG_DWORD /d "1" /f
timeout /t 1 /nobreak > NUL

echo %w%- Remove people button %b%
...
echo %w%- Enable numlock on startup %b%
...
echo.
echo.
echo.                                         %p%[1]%w% General AMD Gpu Tweaks        %p%[2]%w% Disable Power Saving Features
echo.
echo.                                         %p%[3]%w% Disable HDCP                  %p%[4]%w% Disabling GPU Memory Clock Sleep State
echo.
echo.                                         %p%[5]%w% Disable Thermal Throttoling   %p%[6]%w% Enabling De-Lag
echo.
echo.                                         %p%[7]%w% Disabling AMD Logging         %p%[8]%w% Adavanced Tweaks
echo. 
echo.
echo.                                                              Type%p% "X" %w%to go back to menu
echo.
...
echo %w%- Turning Off power Saving Features on Usb and more %b%
...
echo %w%- Tweaking Usb Thread Priority %b%
...
goto :god
:firm
echo %w%- Enable Memory Mapping for PCI-E devices %b%
bcdedit /set configaccesspolicy Default
bcdedit /set MSI Default
bcdedit /set usephysicaldestination No
bcdedit /set usefirmwarepcisettings No
...
echo %w%- Turn Core Isolation Memory Integrity OFF %b%
timeout /t 1 /nobreak > nul
...
echo %w%- Disable Process Mitigations %b%
timeout /t 1 /nobreak > nul
::Disable TsX to mitigate ZombieLoad
Reg.exe add "HKLM\System\CurrentControlSet\Control\Session Manager\kernel" /v "DisableTsx" /t REG_DWORD /d "1" /f
echo %w%- Disable TsX to mitigate ZombieLoad %b%
timeout /t 1 /nobreak > nul
...
echo %w%- Disable Spectre And Meltdown %b%
timeout /t 1 /nobreak > nul
::Disable CFG Lock
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "EnableCfg" /t REG_DWORD /d "0" /f
echo %w%- Disable CFG Lock %b%
timeout /t 1 /nobreak > nul
...
echo %w%- Disable NTFS/ReFS and FS Mitigations %b%
timeout /t 1 /nobreak > nul
...
Reg.exe add "HKLM\System\CurrentControlSet\Control\Session Manager" /v "ProtectionMode" /t Reg_DWORD /d "0" /f
echo %w%- Disabling  NTFS/ReFS and mitigations %b%
timeout /t 1 /nobreak > nul

echo %w%-  Sub Mitigations %b%
...
:latency
echo %w%- Disabling IO Latency Cap: %b%
...
:random
echo %w%- Enabling distribute timers %b%
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v "DistributeTimers" /t REG_DWORD /d "1" /f
timeout /t 1 /nobreak > nul

echo %w%- NVMe Power State Transition Latency Tolerance %b%
...
timeout /t 1 /nobreak > nul
echo %w%- Low Latency Scaling Percentage %b%
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "LowLatencyScalingPercentage" /t REG_DWORD /d "100" /f
timeout /t 1 /nobreak > nul

echo %w%-  Rebuilding Performance Counters %b%
echo.
lodctr /r
...
:p17
echo %w%- Disable Storage Power Saving features %b%
...
:p14
echo %w%- Deleting Default Power Plans %b%
...
cls
chcp 437 > nul
echo %w%- Disable Device Power Managment %b%
...
:gpuenrg
echo %w%- Disable GPU energy driver %b%
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\GpuEnergyDrv" /v "Start" /t REG_DWORD /d "4" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\GpuEnergyDr" /v "Start" /t REG_DWORD /d "4" /f
echo.
echo.
...
:pst
echo %w%- Enable Hardware P-states %b%
...
:Throttoling
echo %w%- Disable Power Throttoling %b%
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "CoalescingTimerInterval" /t REG_DWORD /d "0" /f
...
:p12
echo %w%- Disable CoalescingTimerIntervalt %b%
...
:p16
echo %w%- Disable Energy Estimation + Telementary %b%
...
echo %w%- Applying Exm Premium power plan %b%
...
timeout /t 1 /nobreak > NUL
echo %w%- Disabling Mouse Smoothing %b%
...
:crss
echo %w%- Setting Debug Poll Interval %b%
...
echo %w%- Optimizing Mouse settings in Control Panel %b%
...
cls
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE ON ETHERNET, If you are on wireless interent skip them, stable tweaks for wifi dont exist', 'Exm Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
echo %w%- Making a restore point...
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'Exm Network Restore Point' -RestorePointType 'MODIFY_SETTINGS'" 
chcp 65001 > nul
...
echo.
echo.                               %p%[10]%w% Disable Netbios over TCPIP           %p%[11]%w% Network Throttling Index     %p%[12]%w% Disable IPV6
echo.
...
Echo.
Echo.
echo %w%- Only do these if you got fast download speeds, type "yes" if you have, "no" if you dont  %b%
set /p input=:
...
:netbios
echo %w%- Set Netbios over TCPIP %b%
...
echo. Delete network Device Priority %b%
Reg.exe add "HKLM\System\CurrentControlSet\Enum\%%i\Device Parameters\Interrupt Management\Affinity Policy" /v "DevicePriority" /f
echo. Enable MSI Mode on NetAdapter %b%
Reg.exe add "HKLM\System\CurrentControlSet\Enum\%%i\Device Parameters\Interrupt Management\MessageSignaledInterruptProperties" /v "MSISupported" /t REG_DWORD /d "1" /f
)
...
echo %w%- Reseting all internet settings %b%
...
echo %w%- Stopping Network Throttoling %b%

netsh advfirewall firewall add rule name="StopThrottling" dir=in action=block remoteip=173.194.55.0/24,206.111.0.0/16 enable=yes
timeout /t 1 /nobreak > nul

echo %w%- Disabling Network Limiting %b%
...
echo %w%- Disabling Network Power Managment %b%
...
echo %w%- Disabling Hidden Power Saving Network Features and nic power saving features %b%
...
echo %w%- TCP Congestion Control/Avoidance Algorithm %b%
